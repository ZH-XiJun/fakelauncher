...
private constructor(
  ...
  companion object {
    ...
    private val SESSION_TOKEN = Util.intToStringMaxRadix(2)
    private val SUPPORTS_AUTO = Util.intToStringMaxRadix(3)
    private val SUPPORTS_AUTOMOTIVE = Util.intToStringMaxRadix(4)
